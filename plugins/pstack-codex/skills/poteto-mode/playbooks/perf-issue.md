...
3. Plan the fix from the trace. If it crosses a function boundary, `architect` first. Delegate implementation using [model routing](../references/model-routing.md); review the diff. Capture a post-fix trace.
