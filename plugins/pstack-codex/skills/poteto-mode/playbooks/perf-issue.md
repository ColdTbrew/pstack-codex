...
3. Plan the fix from the trace. If it crosses a function boundary, `architect` first. Delegate implementation to `pstack_builder_sol`; review the diff. Capture a post-fix trace.
