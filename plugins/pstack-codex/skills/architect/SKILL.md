...
Create or update a Codex plan with one entry per phase before starting.
...
Use the `$pstack-codex:arena` candidate set for the task difficulty from [model routing](../poteto-mode/references/model-routing.md).
