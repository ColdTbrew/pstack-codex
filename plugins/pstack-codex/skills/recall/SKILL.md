...
Use Codex task tools to list and read relevant prior tasks. When local memory is available, search `~/.codex/memories/MEMORY.md` and only open the directly referenced rollout summaries needed for exact evidence.
