...
- `Read` tool calls against any `SKILL.md` file (workspace `.agents/skills/`, user-level `~/.agents/skills/`, or plugin-installed paths under `Codex-installed plugin paths/`)
- a Codex subagent prompts that name a skill path
